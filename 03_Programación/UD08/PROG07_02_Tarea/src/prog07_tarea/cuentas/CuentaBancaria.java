...
Descripción: Clase donde hay una composición, ya que se incluye la clase Persona en ella.  También se implementa la interfaz Imprimible
y será la clase padre de las diferentes cuentas bancarias: Cuentas corrientes y cuenta ahorro.
 */
